...
public class SocialClientRegistration {
    ...
    public ClientRegistration kakaoClientRegistration() {
        return ClientRegistration.withRegistrationId("kakao")
            .clientId(kakaoId)
            .redirectUri("https://" + domainUrl + "/api/login/oauth2/code/kakao")
    ...
    public ClientRegistration naverClientRegistration() {
        return ClientRegistration.withRegistrationId("naver")
            ...
            .redirectUri("https://" + domainUrl + "/api/login/oauth2/code/naver")
            .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
            .scope()
    ...
    public ClientRegistration xClientRegistration() {
        return ClientRegistration.withRegistrationId("x")
            ...
            .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
            .redirectUri("https://" + domainUrl + "/api/login/oauth2/code/x")
    ...
    public ClientRegistration googleClientRegistration() {
        return ClientRegistration.withRegistrationId("google")
            ...
            .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
            .redirectUri("https://" + domainUrl + "/api/login/oauth2/code/google")
            .scope("openid")
