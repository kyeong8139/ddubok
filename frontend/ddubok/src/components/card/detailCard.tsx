...
const DetailCard = ({ writer, image, content, effect }: IDetailCardProps) => {
	...
	return (
		<div id="detail-card">
			...
			<div
				id="content"
				className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg p-8 z-10 overflow-hidden text-center"
			>
				<div className="font-nexonBold text-white flex items-center justify-between mb-4">
					<p>From. {writer}</p>
					<span className="bg-white rounded-full p-1 shadow-[0px_3px_0px_0px_#9E9E9E]">
						<Siren
							size={14}
							color="red"
							weight="fill"
